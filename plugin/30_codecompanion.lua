...
if config.ai.codecompanion then
  later(function()
    ...
    -- keymaps
    vim.keymap.set("n", "<A-b>", "<cmd>CodeCompanionChat Toggle<CR>",
      { noremap = true, silent = true, desc = "Toggle CodeCompanion Chat" })

    vim.keymap.set("x", "<A-b>", "<cmd>CodeCompanionChat Toggle<CR>",
      { noremap = true, silent = true, desc = "Send Selected Text to CodeCompanion Chat" })

    vim.keymap.set("x", "<A-i>", "<cmd>CodeCompanion<CR>",
