...
vim.keymap.set("n", "[p", '<Cmd>exe "put! " . v:register<CR>', { noremap = true, silent = true, desc = "Paste Above" })

vim.keymap.set("n", "]p", '<Cmd>exe "put "  . v:register<CR>', { noremap = true, silent = true, desc = "Paste Below" })
...
-- Leader mappings
vim.keymap.set("n", "<Leader>uu", "<Cmd>DepsUpdate<CR>", { noremap = true, silent = true, desc = "Update Plugins" })
...
vim.keymap.set("n", "<C-t>", "<Cmd>enew<CR>", { noremap = true, silent = true, desc = "New Buffer" })

vim.keymap.set("n", "<Leader>ba", "<Cmd>b#<CR>", { noremap = true, silent = true, desc = "Alternate" })
...
vim.keymap.set("n", "<Leader>bn", "<Cmd>bnext<CR>", { noremap = true, silent = true, desc = "Next" })

vim.keymap.set("n", "<Leader>bb", "<Cmd>bprev<CR>", { noremap = true, silent = true, desc = "Prev" })

vim.keymap.set("n", "<Leader>bs", new_scratch_buffer, { noremap = true, silent = true, desc = "Scratch" })
...
vim.keymap.set("n", "<c-n>", "<Cmd>MiniFilesToggle<CR>", { noremap = true, silent = true, desc = "Directory" })

vim.keymap.set("n", "<Leader>ef", explore_at_file, { noremap = true, silent = true, desc = "File directory" })
...
vim.keymap.set("n", "<Leader>eQ", explore_locations, { noremap = true, silent = true, desc = "Location list" })

-- Pick/Fuzzy find mappings
local pick_added_hunks_buf = '<Cmd>Pick git_hunks path="%" scope="staged"<CR>'
local pick_workspace_symbols_live = '<Cmd>Pick lsp scope="workspace_symbol_live"<CR>'

vim.keymap.set("n", "<Leader>fb", "<Cmd>Pick buffers<CR>", { noremap = true, silent = true, desc = "Buffers" })
...
vim.keymap.set("n", "<Leader>fh", "<Cmd>Pick help<CR>", { noremap = true, silent = true, desc = "Help tags" })
...
vim.keymap.set("n", "<Leader>gl", "<Cmd>" .. git_log_cmd .. "<CR>", { noremap = true, silent = true, desc = "Log" })
...
vim.keymap.set("n", "rn", "<Cmd>lua vim.lsp.buf.rename()<CR>", { noremap = true, silent = true, desc = "Rename" })
...
vim.keymap.set("n", "<Leader>mr", "<Cmd>lua MiniMap.refresh()<CR>", { noremap = true, silent = true, desc = "Refresh" })
...
vim.keymap.set("n", "<Leader>mt", "<Cmd>lua MiniMap.toggle()<CR>", { noremap = true, silent = true, desc = "Toggle" })
...
vim.keymap.set("n", "<Leader>sn", "<Cmd>lua " .. session_new .. "<CR>", { noremap = true, silent = true, desc = "New" })
...
vim.keymap.set(
	"n",
	"<Leader>vc",
	make_pick_core("", "Core visits (all)"),
...
vim.keymap.set(
	"n",
	"<Leader>vC",
	make_pick_core(nil, "Core visits (cwd)"),
...
vim.keymap.set("n", "<A-k>", require("smart-splits").resize_up, { noremap = true, silent = true, desc = "Resize up" })
